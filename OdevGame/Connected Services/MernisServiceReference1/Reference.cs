...
namespace MernisServiceReference1
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference1.KPSPublicSoap>, MernisServiceReference1.KPSPublicSoap
    {
        ...
        public System.Threading.Tasks.Task<MernisServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
        ...
        internal bool TCKimlikNoDogrulaAsync(object ıdentityNumber, string v1, string v2, int birthYear)
        {
